  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-[16px] p-8 max-h-[90vh] overflow-y-auto",
        "focus:outline-none",
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-syne font-bold text-[22px] leading-none tracking-tight", className)}
...
export { motion, AnimatePresence, modalVariants, backdropVariants };
